<?php
	...
	$CallbackURL = $systemUrl . '/modules/gateways/callback/zarinpalzg.php?invoiceid='. $_POST['invoiceid'] .'&Amount='. $Amount;
	try {
	...
	if($result->Status == 100){ 
		...
		$url = "https://www.zarinpal.com/pg/StartPay/$vahabid/ZarinGat";
		redirect($url);
	} else {
